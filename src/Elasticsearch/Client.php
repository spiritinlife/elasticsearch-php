...
use Elasticsearch7\Common\Exceptions\BadMethodCallException;
...
use Elasticsearch7\Namespaces\BooleanRequestWrapper;
use Elasticsearch7\Namespaces\CatNamespace;
use Elasticsearch7\Namespaces\ClusterNamespace;
use Elasticsearch7\Namespaces\DanglingIndicesNamespace;
use Elasticsearch7\Namespaces\IndicesNamespace;
use Elasticsearch7\Namespaces\IngestNamespace;
use Elasticsearch7\Namespaces\NodesNamespace;
use Elasticsearch7\Namespaces\SnapshotNamespace;
use Elasticsearch7\Namespaces\TasksNamespace;
use Elasticsearch7\Namespaces\AsyncSearchNamespace;
use Elasticsearch7\Namespaces\AutoscalingNamespace;
use Elasticsearch7\Namespaces\CcrNamespace;
use Elasticsearch7\Namespaces\DataFrameTransformDeprecatedNamespace;
use Elasticsearch7\Namespaces\EnrichNamespace;
use Elasticsearch7\Namespaces\EqlNamespace;
use Elasticsearch7\Namespaces\GraphNamespace;
use Elasticsearch7\Namespaces\IlmNamespace;
use Elasticsearch7\Namespaces\LicenseNamespace;
use Elasticsearch7\Namespaces\MigrationNamespace;
use Elasticsearch7\Namespaces\MlNamespace;
use Elasticsearch7\Namespaces\MonitoringNamespace;
use Elasticsearch7\Namespaces\RollupNamespace;
use Elasticsearch7\Namespaces\SearchableSnapshotsNamespace;
use Elasticsearch7\Namespaces\SecurityNamespace;
use Elasticsearch7\Namespaces\SlmNamespace;
use Elasticsearch7\Namespaces\SqlNamespace;
use Elasticsearch7\Namespaces\SslNamespace;
use Elasticsearch7\Namespaces\TransformNamespace;
use Elasticsearch7\Namespaces\WatcherNamespace;
use Elasticsearch7\Namespaces\XpackNamespace;

...
use Elasticsearch6\Namespaces\DanglingIndicesNamespace;
...
use Elasticsearch6\Namespaces\AsyncSearchNamespace;
use Elasticsearch6\Namespaces\AutoscalingNamespace;
use Elasticsearch6\Namespaces\CcrNamespace;
use Elasticsearch6\Namespaces\DataFrameTransformDeprecatedNamespace;
use Elasticsearch6\Namespaces\EnrichNamespace;
use Elasticsearch6\Namespaces\EqlNamespace;
use Elasticsearch6\Namespaces\GraphNamespace;
use Elasticsearch6\Namespaces\IlmNamespace;
use Elasticsearch6\Namespaces\LicenseNamespace;
use Elasticsearch6\Namespaces\MigrationNamespace;
use Elasticsearch6\Namespaces\MlNamespace;
use Elasticsearch6\Namespaces\MonitoringNamespace;
use Elasticsearch6\Namespaces\RollupNamespace;
use Elasticsearch6\Namespaces\SearchableSnapshotsNamespace;
use Elasticsearch6\Namespaces\SecurityNamespace;
use Elasticsearch6\Namespaces\SlmNamespace;
use Elasticsearch6\Namespaces\SqlNamespace;
use Elasticsearch6\Namespaces\SslNamespace;
use Elasticsearch6\Namespaces\TransformNamespace;
use Elasticsearch6\Namespaces\WatcherNamespace;
use Elasticsearch6\Namespaces\XpackNamespace;

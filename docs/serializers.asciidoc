...
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch6\Serializers\SmartSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch6\Serializers\ArrayToJSONSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch6\Serializers\EverythingToJSONSerializer');
            ->build();
----

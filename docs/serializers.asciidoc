...
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch7\Serializers\SmartSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch7\Serializers\ArrayToJSONSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Elasticsearch7\Serializers\EverythingToJSONSerializer');
            ->build();
----

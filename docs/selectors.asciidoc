...
$client = ClientBuilder::create()
            ->setSelector('\Elasticsearch6\ConnectionPool\Selectors\RoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\Elasticsearch6\ConnectionPool\Selectors\StickyRoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\Elasticsearch6\ConnectionPool\Selectors\RandomSelector')
            ->build();
----

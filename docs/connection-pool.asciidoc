...
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch7\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch7\ConnectionPool\StaticConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch7\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch7\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----

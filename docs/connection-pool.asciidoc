...
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch6\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch6\ConnectionPool\StaticConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch6\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Elasticsearch6\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
